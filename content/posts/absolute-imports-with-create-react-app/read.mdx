...
This is totally fine, until your project becomes very large and some files are several levels deep. It becomes more stressfull to import
...
the project root folder. And add the configuration. If you are using typescript, you should create a `tsconfig.json` instead and add the same configuration.
